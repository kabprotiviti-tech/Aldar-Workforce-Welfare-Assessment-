...
import { sendDueDeadlineWarnings } from "@/lib/notifications/send-deadline-warnings";
 ...
 * configured, every request is rejected rather than the warning
 * schedule running unauthenticated.
 */
export async function GET(request: NextRequest) {
  ...
  const result = await sendDueDeadlineWarnings();
